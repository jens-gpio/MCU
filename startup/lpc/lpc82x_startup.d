...
@exc extern(C) void ADC_SEQA_IRQHandler();
@exc extern(C) void ADC_SEQB_IRQHandler();
@exc extern(C) void ADC_THCMP_IRQHandler();
@exc extern(C) void ADC_OVR_IRQHandler();
@exc extern(C) void DMA_IRQHandler();
@exc extern(C) void I2C2_IRQHandler();
@exc extern(C) void I2C3_IRQHandler();
...
@isr_vector VectorFunc[48] g_pfnVectors = [
	...
	&ADC_SEQA_IRQHandler,															/*  16 $0080 ADC sequence A completion */
	&ADC_SEQB_IRQHandler,															/*  17 $0084 ADC sequence B completion */
	&ADC_THCMP_IRQHandler,															/*  18 $0088 ADC threshold compare */
	&ADC_OVR_IRQHandler,															/*  19 $008c ADC_OVR_IRQHandler */
	&DMA_IRQHandler,																/*  20 $0090 Reserved */
	&I2C2_IRQHandler,																/*  21 $0094 Reserved */
	&I2C3_IRQHandler,																/*  22 $0098 Reserved */
