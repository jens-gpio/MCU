...
@exc extern(C) void MCI_IRQHandler();
...
@exc extern(C) void SSP2_IRQHandler();
@exc extern(C) void GPIO_IRQHandler();
@exc extern(C) void PWM0_IRQHandler();
@exc extern(C) void EEPROM_IRQHandler();

@isr_vector VectorFunc[56] g_pfnVectors = [
	...
	&MCI_IRQHandler,																/*  29 $00b4 SD/MMC Card */
	...
	&UART4_IRQHandler,																/*  35 $00cc UART4 */
	&SSP2_IRQHandler,																/*  36 $00d0 LCD_IRQHandler */
	&GPIO_IRQHandler,																/*  37 $00d4 GPIO */
	&PWM0_IRQHandler,																/*  38 $00d8 PWM0 */
	&EEPROM_IRQHandler,																/*  39 $00dc EEPROM */
	];
