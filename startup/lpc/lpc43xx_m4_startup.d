...
@exc extern(C) void M0CORE_IRQHandler();
@exc extern(C) void DMA_IRQHandler();
@exc extern(C) void EZH_IRQHandler();
@exc extern(C) void FLASH_EEPROM_IRQHandler();
...
@exc extern(C) void M0s_IRQHandler();
...
@isr_vector VectorFunc[] g_pfnVectors = [
	...
	&M0CORE_IRQHandler,																/*   1 $0044 M0 Core */
	&DMA_IRQHandler,																/*   2 $0048 General Purpose DMA */
	&EZH_IRQHandler,																/*   3 $004c EZH/EDM */
	&FLASH_EEPROM_IRQHandler,														/*   4 $0050 Reserved for Typhoon */
	...
	&I2S0_IRQHandler,																/*  28 $00b0 I2S0 */
	&I2S1_IRQHandler,																/*  29 $00b4 I2S1 */
