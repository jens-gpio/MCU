...
@exc extern(C) void HRTIM1_Master_IRQHandler();
@exc extern(C) void HRTIM1_TIMA_IRQHandler();
@exc extern(C) void HRTIM1_TIMB_IRQHandler();
@exc extern(C) void HRTIM1_TIMC_IRQHandler();
@exc extern(C) void HRTIM1_TIMD_IRQHandler();
@exc extern(C) void HRTIM1_TIME_IRQHandler();
@exc extern(C) void HRTIM1_FLT_IRQHandler();
...
@isr_vector VectorFunc[] g_pfnVectors = [
	...
	&HRTIM1_Master_IRQHandler,														/*  67 $014c HRTIM1 Master */
	&HRTIM1_TIMA_IRQHandler,														/*  68 $0150 HRTIM1 TIMA */
	&HRTIM1_TIMB_IRQHandler,														/*  69 $0154 HRTIM1 TIMB */
	&HRTIM1_TIMC_IRQHandler,														/*  70 $0158 HRTIM1 TIMC */
	&HRTIM1_TIMD_IRQHandler,														/*  71 $015c HRTIM1 TIMD */
	&HRTIM1_TIME_IRQHandler,														/*  72 $0160 HRTIM1 TIME */
	&HRTIM1_FLT_IRQHandler,															/*  73 $0164 HRTIM1 FLT */
