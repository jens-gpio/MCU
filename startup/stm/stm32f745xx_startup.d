...
@exc extern(C) void SDMMC1_IRQHandler();
...
@exc extern(C) void RNG_IRQHandler();
...
@exc extern(C) void SAI2_IRQHandler();
@exc extern(C) void QUADSPI_IRQHandler();
@exc extern(C) void LPTIM1_IRQHandler();
@exc extern(C) void CEC_IRQHandler();
@exc extern(C) void I2C4_EV_IRQHandler();
@exc extern(C) void I2C4_ER_IRQHandler();
@exc extern(C) void SPDIF_RX_IRQHandler();

@isr_vector VectorFunc[114] g_pfnVectors = [
	...
	&SDMMC1_IRQHandler,																/*  49 $0104 SDMMC1 */
	...
	&SAI2_IRQHandler,																/*  91 $01ac SAI2 */
	&QUADSPI_IRQHandler,															/*  92 $01b0 QUADSPI */
	&LPTIM1_IRQHandler,																/*  93 $01b4 LPTIM1 */
	&CEC_IRQHandler,																/*  94 $01b8 HDMI_CEC */
	&I2C4_EV_IRQHandler,															/*  95 $01bc I2C4 Event */
	&I2C4_ER_IRQHandler,															/*  96 $01c0 I2C4 Error */
	&SPDIF_RX_IRQHandler,															/*  97 $01c4 SPDIF_RX */
	];
