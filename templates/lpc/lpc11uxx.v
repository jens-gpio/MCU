	...
	USB0_IRQHandler,						/* USB IRQ interrupt */
	USB0_FIQ_IRQHandler,					/* USB FIQ interrupt */
	...
	USB_WAKEUP_IRQHandler,					/* USB wake-up interrupt Interrupt */
	IOH_IRQHandler,							/* I/O Handler IRQ (Only for LPC11U37) */
